...
int main(int argc, char *argv[])
{
    ...
    MPI_Comm comm,comm_inverso; // nuevo para todos los procesos pero con rank inverso.
    ...
    cout << "Soy el proceso " << rank << " de " << size << " dentro de MPI_COMM_WORLD,\n\t mi rango en COMM_nuevo es "
         << rank_nuevo << ", de " << size_nuevo << ", aqui he recibido el valor " << a << ",\n\ten COMM_inverso mi rango es " << rank_inverso << " de " << size_inverso
         << " aqui he recibido el valor " << b << "\n Y el valor recibido de la modificación es: "<< recibido
         << endl;
